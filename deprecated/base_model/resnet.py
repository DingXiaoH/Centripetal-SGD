...
from constants import rc_origin_deps_flattened, rc_convert_flattened_deps
...
def create_RC56(cfg, builder):
    return RCNet(block_counts=[9,9,9], num_classes=10, builder=builder, deps=cfg.deps)

def create_RC110(cfg, builder):
    return RCNet(block_counts=[18,18,18], num_classes=10, builder=builder, deps=cfg.deps)

def create_RC164(cfg, builder):
    return RCNet(block_counts=[27,27,27], num_classes=10, builder=builder, deps=cfg.deps)

def create_RH56(cfg, builder):
    return RCNet(block_counts=[9,9,9], num_classes=100, builder=builder, deps=cfg.deps)

def create_RH110(cfg, builder):
    return RCNet(block_counts=[18,18,18], num_classes=100, builder=builder, deps=cfg.deps)

def create_RH164(cfg, builder):
    return RCNet(block_counts=[27,27,27], num_classes=100, builder=builder, deps=cfg.deps)
